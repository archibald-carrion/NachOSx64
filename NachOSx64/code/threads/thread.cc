...
/**
* function return a 0 if the openFilesTable is nullptr aka not initialized
* else the function return a 1 if the openFilesTable is initialized
*/
bool Thread::tableIsInitialized() {
    return this->openFilesTable != nullptr;
}

/**
* setFileTable function set the openFilesTable attribute to the value of the given filesTable
*/
void Thread::setFileTable(NachosOpenFilesTable* filesTable) {
    this->openFilesTable = filesTable;
}
