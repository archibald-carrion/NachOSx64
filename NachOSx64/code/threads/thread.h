...
class Thread {
  ...
  public:
    ...
    /**
    * tableIsInitialized allow user program to check if the thread owm a
    * pointer to an instance of NachosOpenFilesTable
    */
    bool tableIsInitialized();

    /**
    * function that give a file table to the thread, either used in create, or fork
    */
    void setFileTable(NachosOpenFilesTable* filesTable);
